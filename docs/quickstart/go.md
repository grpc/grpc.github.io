...
For the purpose of this example, `helloworld.pb.go` file has already been generated (by compiling `helloworld.proto`) and can be found under this directory: `$GOPATH/src/google.golang.org/grpc/examples/helloworld/helloworld`
