...
The asynschronous stub signature for a unary RPC method `unaryExample`:
...
The asynschronous stub signature for a server-streaming RPC method
`serverStreamingExample`:
...
The asynschronous stub signature for a client-streaming RPC method
`clientStreamingExample`:
...
The asynschronous stub signature for a bidirectional-streaming RPC method
`bidirectionalStreamingExample`:
